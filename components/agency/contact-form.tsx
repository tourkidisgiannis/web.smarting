    ...
    >
      <div className="py-20 md:py-32 w-full">
        <div className="container relative overflow-visible">
          ...
          <div
            ref={shape1Ref}
            className="absolute -top-20 right-0 lg:right-[10%] h-64 w-64 bg-[var(--blue-green-400)]/20 blur-[80px] -z-10"
          />
          <div
            ref={shape2Ref}
            className="absolute bottom-0 left-0 lg:left-[10%] h-80 w-80 bg-[var(--sky-blue-light-300)]/20 blur-[80px] -z-10"
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity">
                ...
                >
                  <path
                    d="M0 0V60H60V0H0ZM58 58H2V2H58V58Z"
                    fill="currentColor"
                    className="text-[var(--blue-green-500)]"
                  />
                </svg>
              </div>
                ...
                <Form {...form}>
                  ...
                  >
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <textarea
                                ...
                                className="bg-white/50 border border-[var(--sky-blue-light-200)] rounded-md p-3 w-full h-24 focus:ring-[var(--blue-green-400)]/30 focus:border-[var(--blue-green-500)] transition-all text-base"
                                {...field}
                              />
                            </FormControl>
                            <FormMessage />
                    ...
                    <Button
                      type="submit"
                      size="xl"
                      className="w-full h-12 sm:h-14 bg-[var(--blue-green-500)] hover:bg-[var(--blue-green-600)] text-white text-base sm:text-lg font-medium shadow-lg shadow-[var(--blue-green-500)]/20 hover:scale-[1.02] hover:shadow-[var(--blue-green-500)]/30 transition-all duration-300 group/btn"
                      disabled={form.formState.isSubmitting}
                    >
                      Ζητήστε Ιδιωτική Αξιολόγηση
                      <svg
                        className="ml-2 h-4 w-4 sm:h-5 sm:w-5 transition-transform group-hover/btn:translate-x-1"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
