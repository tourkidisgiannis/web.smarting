...
const demos = [
  ...
  {
    title: "Σχεδιαστικό Γραφείο",
    description:
      "Αποτυπώστε το μοναδικό σας όραμα και προβάλλετε το ταλέντο σας με τρόπο που εντυπωσιάζει.",
    icon: Palette,
    href: "/demos/creative",
...
export function DemoGrid() {
  ...
  return (
    <div id="demos" ref={containerRef} className="relative">
      {/* Header Section */}
      <section className="relative z-10 min-h-[50vh] flex items-center justify-center demo-grid-bg">
        <div className="container py-16 md:py-24">
          <div ref={headerRef} className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-[var(--deep-space-blue-700)] text-base md:text-lg">
              Εξερευνήστε πώς προσαρμόζουμε την τεχνολογία στις ανάγκες του
              δικού σας επαγγέλματος για μέγιστα αποτελέσματα.
            </p>
          </div>
        </div>
      </section>
      ...
      {demos.map((demo, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            ...
            />
            <div
              className={`absolute inset-0 bg-gradient-to-br ${demo.bgGradient} mix-blend-multiply opacity-80`}
            />
          ...
          <div className="container relative z-10 h-full min-h-screen flex items-center justify-center py-12 md:py-16 px-4 sm:px-6">
            <Link href={demo.href} className="group w-full max-w-3xl">
              <div className="relative overflow-hidden bg-white/10 backdrop-blur-xl border border-white/20 transition-all duration-500 hover:scale-[1.02] hover:border-[var(--blue-green-400)]/50">
                {/* Content */}
                <div className="relative p-8 md:p-14 lg:p-20 text-center">
                  {/* Icon */}
                  <div
                    className={`inline-flex h-20 w-20 md:h-24 md:w-24 items-center justify-center bg-white/10 backdrop-blur-2xl border border-white/20 text-white mb-8 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3`}
                  >
                  ...
                  <div className="inline-flex items-center gap-3 px-8 py-4 bg-white text-[var(--deep-space-blue-900)] font-bold text-lg md:text-xl transition-all duration-300 group-hover:bg-[var(--blue-green-500)] group-hover:text-white group-hover:shadow-[0_0_30px_rgba(var(--blue-green-rgb),0.5)]">
                    Εξερεύνηση{" "}
